 ...
 * 
 * <br>Revisions:
 *    <br>2.1 Dave Parkinson - Updated Explorer test, added TestDrawables(), 
 *    <br>    changed fixedSquares to DrawableSquare[][], added test driver line output
...
public class P3TestDriver
{
   ...
   private static DrawableSquare[][] fixedSquares = new DrawableSquare[5][5];
   ...
   public static void main(String[] args)
   {
      ...
      {
         pass &= false;
         System.out.println("FAILED, runtime exception testing Drawables");
         e.printStackTrace();
      }
   ...
   private static boolean testExplorer()
   {
      ...
      ex.moveTo(fixedSquares[2][3]);
      ex.move(KeyEvent.VK_DOWN);
      pass &= test(ex.location() == fixedSquares[3][3], test++);  // test 23
      pass &= test(!fixedSquares[1][3].inView(), test++);  // test 24
      pass &= test(fixedSquares[3][3].inView(), test++);  // test 25
      pass &= test(!fixedSquares[3][4].inView(), test++);  // test 26
      pass &= test(!fixedSquares[3][2].inView(), test++);  // test 27
      pass &= test(!fixedSquares[4][3].inView(), test++);  // test 28
      pass &= test(fixedSquares[2][3].inView(), test++);  // test 29
      pass &= test(fixedSquares[3][3].treasure().found(), test++);  // test 30
   ...
   private static boolean testTreasure()
   {
      ...
      treasure = new Treasure(maze, 0);      
      pass &= test(treasure.location().treasure() != null, test++);  // test 1
      
      pass &= test(treasure.location() != null, test++);  // test 2
      pass &= test(treasure.location().row() == 0, test++);  // test 3
      pass &= test(treasure.location().col() == 3, test++);  // test 4
      pass &= test(!treasure.found(), test++);  // test 5
      
      treasure.move();
      pass &= test(treasure.location().row() == 0, test++);  // test 6
      pass &= test(treasure.location().col() == 3, test++);  // test 7
      
      treasure = new Treasure(maze);      
      pass &= test(treasure.location().treasure() != null, test++);  // test 8
      
      pass &= test(treasure.location() != null, test++);  // test 9
      pass &= test(!treasure.found(), test++);  // test 10

      prevLoc = treasure.location();
      treasure.move();
      pass &= test(treasure.location() == prevLoc, test++);  // test 11
      
      treasure = new Treasure(maze, fixedSquares[0][0]);
      pass &= test(treasure.location().treasure() != null, test++);  // test 12      
      
      pass &= test(treasure.location() == fixedSquares[0][0], test++);  // test 13
      pass &= test(!treasure.found(), test++);  // test 14
      
      treasure.setFound();
      pass &= test(treasure.found(), test++);  // test 15
      
      return pass;  
   }
   
   private static boolean testDrawables()
   {
      boolean pass = true;
      int test = 1;
      
      System.out.println("Drawable tests...");
 
      DrawableSquare[][] dSquares = new DrawableSquare[1][1];
      
      // Test for DrawableSquare not swapping wall booleans
      dSquares[0][0] = new DrawableSquare(true, true, false, false, 0, 0);
      pass &= test(dSquares[0][0].wall(0), test++); // test 1
      pass &= test(dSquares[0][0].wall(1), test++); // test 2      
      pass &= test(!dSquares[0][0].wall(2), test++); // test 3
      pass &= test(!dSquares[0][0].wall(3), test++); // test 4       
      
      dSquares[0][0] = new DrawableSquare(false, true, false, true, 0, 0);
      pass &= test(!dSquares[0][0].wall(0), test++); // test 5
      pass &= test(dSquares[0][0].wall(1), test++); // test 6      
      pass &= test(!dSquares[0][0].wall(2), test++); // test 7
      pass &= test(dSquares[0][0].wall(3), test++); // test 8       

      dSquares[0][0] = new DrawableSquare(true, true, true, true, 0, 0);

      // Ensure DrawableSquares array makes it to Maze
      DrawableMaze dMaze = new DrawableMaze(dSquares, 1, 1);
      pass &= test(dMaze.getSquare(0,0).wall(1), test++); // test 9
      
      DrawableTreasure dTreas = new DrawableTreasure(dMaze);
      pass &= test(dTreas.location().treasure() == dTreas, test++); // test 10
      pass &= test(!dTreas.found(), test++); // test 11
      
      DrawableExplorer dExp = new DrawableExplorer(dSquares[0][0], dMaze, "Drawable");
      pass &= test(dExp.name().equals("Drawable"), test++); // test 12
      pass &= test(dExp.location() == dSquares[0][0], test++); // test 13
      
      DrawableMonster dMon = new DrawableMonster(dMaze);
      pass &= test(dMon.location() == dSquares[0][0], test++); // test 14
   ...
   private static boolean testMaze()
   {
      ...
      // Objects will be Drawable in processing, so test with those classes
      initSquares();
      maze = new DrawableMaze(fixedSquares, 5, 5);
      ...
      ex = new DrawableExplorer(fixedSquares[0][0], maze, "Scary Name");
      maze.setExplorer(ex);
      ...
      t1 = new DrawableTreasure(maze, fixedSquares[4][4]);
      ...
      m1 = new DrawableMonster(maze, fixedSquares[4][4]);
      m2 = new DrawableMonster(maze, fixedSquares[3][3]);
      ...
      maze.addRandomOccupant(new DrawableMonster(maze, fixedSquares[0][1]));
   ...
   {
      fixedSquares[0][0] = new DrawableSquare(true, false, false, true, 0, 0);
      fixedSquares[0][1] = new DrawableSquare(true, false, true, false, 0, 1);
      fixedSquares[0][2] = new DrawableSquare(true, false, true, false, 0, 2);
      fixedSquares[0][3] = new DrawableSquare(true, false, false, false, 0, 3);
      fixedSquares[0][4] = new DrawableSquare(true, true, false, false, 0, 4);
      fixedSquares[1][0] = new DrawableSquare(false, false, true, true, 1, 0);
      fixedSquares[1][1] = new DrawableSquare(true, false, true, false, 1, 1);
      fixedSquares[1][2] = new DrawableSquare(true, true, false, false, 1, 2);
      fixedSquares[1][3] = new DrawableSquare(false, true, false, true, 1, 3);
      fixedSquares[1][4] = new DrawableSquare(false, true, false, true, 1, 4);
      fixedSquares[2][0] = new DrawableSquare(true, false, false, true, 2, 0);
      fixedSquares[2][1] = new DrawableSquare(true, false, true, false, 2, 1);
      fixedSquares[2][2] = new DrawableSquare(false, true, false, false, 2, 2);
      fixedSquares[2][3] = new DrawableSquare(false, true, false, true, 2, 3);
      fixedSquares[2][4] = new DrawableSquare(false, true, false, true, 2, 4);
      fixedSquares[3][0] = new DrawableSquare(false, true, false, true, 3, 0);
      fixedSquares[3][1] = new DrawableSquare(true, false, false, true, 3, 1);
      fixedSquares[3][2] = new DrawableSquare(false, true, false, false, 3, 2);
      fixedSquares[3][3] = new DrawableSquare(false, true, true, true, 3, 3);
      fixedSquares[3][4] = new DrawableSquare(false, true, false, true, 3, 4);
      fixedSquares[4][0] = new DrawableSquare(false, true, true, true, 4, 0);
      fixedSquares[4][1] = new DrawableSquare(false, true, true, true, 4, 1);
      fixedSquares[4][2] = new DrawableSquare(false, false, true, true, 4, 2);
      fixedSquares[4][3] = new DrawableSquare(true, false, true, false, 4, 3);
      fixedSquares[4][4] = new DrawableSquare(false, true, true, false, 4, 4);
   }
}
